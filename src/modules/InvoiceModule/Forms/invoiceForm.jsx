      ...
      <Row gutter={[12, 0]}>
        ...
        <Col className="gutter-row" span={8}>
          <Form.Item
            ...
            initialValue={dayjs()}
          >
            <DatePicker style={{ width: '100%' }} format={'DD/MM/YYY'} />
          </Form.Item>
        </Col>
      ...
      <div style={{ position: 'relative', width: '100%', float: 'right' }}>
        <Row gutter={[12, -5]}>
          ...
          <Col className="gutter-row" span={4} offset={10}>
            <p style={{ paddingLeft: '12px', paddingTop: '5px' }}>{translate('Sub Total')}</p>
          </Col>
          <Col className="gutter-row" span={5}>
        ...
        <Row gutter={[12, -5]}>
          <Col className="gutter-row" span={4} offset={15}>
            <p style={{ paddingLeft: '12px', paddingTop: '5px' }}>{translate('Total')}</p>
          </Col>
          <Col className="gutter-row" span={5}>
