...
import RecentTable from './compenents/RecentTable';
import SummaryCard from './compenents/SummaryCard';
import PreviewCard from './compenents/PreviewCard';
import CustomerPreviewCard from './compenents/CustomerPreviewCard';
...
export default function DashboardModule() {
  ...
  const dataTableColumns = [
    ...
    { title: translate('Client'), dataIndex: ['client', 'company'] },
    {
  ...
  const cards = entityData.map((data, index) => {
    ...
    return (
      <SummaryCard
        ...
        tagColor={
          data?.entity === 'invoice' ? 'cyan' : data?.entity === 'quote' ? 'pruple' : 'green'
        }
