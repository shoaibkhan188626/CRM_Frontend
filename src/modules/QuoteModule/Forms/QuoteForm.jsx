...
export default function QuoteForm({ subTotal = 0, current = 0 }) {
...
function LoadQuoteForm({ subTotal = 0, current = null }) {
  ...
  useEffect(() => {
    ...
    setTaxRate(Number.parseFloat(calculate.multiply(subTotal, taxRate)));
    ...
    <>
      ...
      <div style={{ position: 'relative', width: '100%', float: 'right' }}>
        <Row gutter={[12, -5]}>
          <Col className="gutter-row" span={5}>
            <Form.Item>
              <Button type="primarry" htmlType="submit" icon={<PlusOutlined />} block>
                {translate('Save')}
              </Button>
            </Form.Item>
          </Col>
